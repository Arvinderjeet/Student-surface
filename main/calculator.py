...
##=====================================##
tk = tkinter.Tk()  
tk.geometry("320x500+1030+200")
tk.resizable(0, 0)  
tk.title("CALCULATOR")
tk.iconbitmap('F:\\CODING\\aj_singh\\ico\\Calculator-icon.ico')
##=======================================##
var = ""  
A = 0  
operator = ""  
...
frameOne = Frame(tk, bg = "#000000")  
frameOne.pack(expand = True, fill = "both") 
frameTwo = Frame(tk, bg = "#000000")  
frameTwo.pack(expand = True, fill = "both")  
  
frameThree = Frame(tk, bg = "#000000")  
frameThree.pack(expand = True, fill = "both")  
  
frameFour = Frame(tk, bg = "#000000")  
